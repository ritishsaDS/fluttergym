...
class GymPackageButtonBar extends StatefulWidget {
  const GymPackageButtonBar(
    this.data, {
    Key? key,
  }) : super(key: key);

  final GymPackage data;

  @override
  State<GymPackageButtonBar> createState() => _GymPackageButtonBarState();
}

class _GymPackageButtonBarState extends State<GymPackageButtonBar> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    var repository = GymPackageRestRepository();
    var account = context.read<AuthCubit>().state.data;
    ...
    if (account != null) {
      repository.purchase(
        PackagePurchaseOption(
          (b) => b
            ..userId = account.id
            ..packageId = widget.data.gymPackageId
